...
export const useTimeSeriesAssetMedia = ({serviceIdentifier, start, end, ...props}: WebCOOSLatestMediaProps): UseQueryResult<IWebCOOSElement[] | null> => {
    const queryResult = useQuery({
        queryKey: ['timeseries', serviceIdentifier, start, end],
