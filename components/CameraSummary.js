...
export default function CameraSummary({
    ...
    return (
        <div
            className={classNames('max-w-screen-2xl grid grid-cols-1 gap-1 p-2 md:grid-cols-camera md:gap-4 md:p-4 border-t-2 border-r-2 border-l-2',
        ...
        >
            ...
            <div className="md:self-center md:justify-self-center">
                {hls_url ? (
                    <VideoStreamPlayer assetUri={hls_url} className="object-contain border" style={{borderColor: borderColor}} />
                ) : (
            ...
            >
                ...
                {hls_url ? (
                    <div>
                        <img {...thumbsProps} className={classNames("border")} style={{borderColor: borderColor}} alt={label} />
                    </div>
                ) : null}
            </div>
        </div>
